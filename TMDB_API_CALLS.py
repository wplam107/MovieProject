...
# Seaborn Plot for Keyword Counts
...
# Query for top directors who have created movies based on books
...
# Seaborn plot of Top 10 Average Box Office Gross of directors who have directed movies based on books
